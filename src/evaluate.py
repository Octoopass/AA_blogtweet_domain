...
CONFIG = {
    ...
    'base_seed': 42,  # Base seed for data selection
...
def main():
    ...
    parser.add_argument('--num-authors', type=int, default=CONFIG['num_authors'],
    ...
    parser.add_argument('--source-tweet-file', type=str, default=CONFIG['source_tweet_file'],
                       help="Path to source tweet CSV file")
    parser.add_argument('--source-blog-file', type=str, default=CONFIG['source_blog_file'],
                       help="Path to source blog CSV file")
    parser.add_argument('--selected-data-dir', type=str, default=CONFIG['selected_data_dir'],
    ...
    parser.add_argument('--unified-model-type', type=str, default=CONFIG['unified_model_type'],
    ...
    parser.add_argument('--tweet-only-model-type', type=str, default=CONFIG['tweet_only_model_type'],
                       choices=['svm', 'logistic_regression', 'xgboost', 'bagging', 'voting', 'all'],
    ...
    parser.add_argument('--use-semantic-clustering', action='store_true', default=CONFIG['use_semantic_clustering'],
    ...
    parser.add_argument('--semantic-cluster-k', type=int, default=CONFIG['semantic_cluster_k'],
                       help=f"Number of semantic clusters for unified model (default: {CONFIG['semantic_cluster_k']})")
    parser.add_argument('--semantic-model-name', type=str, default=CONFIG['semantic_model_name'],
                       help="SentenceTransformer model name used for semantic clustering")
    parser.add_argument('--use-domain-weighting', action='store_true', default=CONFIG['use_domain_weighting'],
    ...
    parser.add_argument('--tweet-weight', type=float, default=CONFIG['tweet_weight'],
                       help=f"Training weight for tweet samples (default: {CONFIG['tweet_weight']})")
    parser.add_argument('--blog-weight', type=float, default=CONFIG['blog_weight'],
    ...
    parser.add_argument('--compare-unified', action='store_true', default=CONFIG['compare_unified'],
                       help="Compare unified blog+tweet model")
    parser.add_argument('--compare-tweet-only', action='store_true', default=CONFIG['compare_tweet_only'],
